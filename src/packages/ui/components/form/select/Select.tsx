  ...
  return (
    <ReactSelect
      ...
      classNames={{
        ...
        control: (state) =>
          cx(
            "bg-white-0 border-soft-200 !min-h-9 h-9 text-sm leading-4 placeholder:text-sm placeholder:font-normal dark:focus:border-emphasis focus-within:outline-none focus-within:ring-2 focus-within:ring-brand-default hover:border-emphasis rounded-[10px] transition border",
            state.isMulti
              ? variant === "checkbox"
                ? "px-3 py-2 h-fit"
                : state.hasValue
        ...
        multiValue: () =>
          cx(
            "bg-subtle text-default rounded-[10px] py-1.5 px-2 flex items-center text-sm leading-tight",
        ...
        menuList: () => cx("scroll-bar scrollbar-track-w-20 rounded-[10px]", innerClassNames?.menuList),
