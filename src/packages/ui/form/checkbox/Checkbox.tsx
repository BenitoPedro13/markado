              ...
              <>
                <div className="flex h-5 items-center">
                  <input
                    ...
                    className={classNames(
                      "text-emphasis focus:ring-emphasis dark:text-muted border-default bg-white-0 focus:bg-white-0 active:bg-white-0 h-4 w-4 rounded transition checked:hover:bg-gray-600 focus:outline-none focus:ring-0 ltr:mr-2 rtl:ml-2",
                      !error && disabled
