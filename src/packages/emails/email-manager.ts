...
import type { EventNameObjectType } from "@/packages/core/event";
import {getEventName} from '@/packages/core/event';
import type BaseEmail from "@/packages/emails/templates/_base-email";
...
import AttendeeRequestEmail from "./templates/attendee-scheduled-email";
