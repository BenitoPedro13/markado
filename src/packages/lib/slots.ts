import type { IFromUser, IOutOfOfficeData, IToUser } from "@/packages/core/getUserAvailability";
import type { Dayjs } from "@/lib/dayjs";
import dayjs from "@/lib/dayjs";
import type { WorkingHours, TimeRange as DateOverride } from "@/types/scheadule";

import { getWorkingHours } from "@/lib/availability";
import { getTimeZone } from "@/lib/date-fns";
...
export type TimeFrame = { userIds?: string[]; startTime: number; endTime: number };
...
function buildSlots({
  ...
  const slots: { time: Dayjs; userIds?: string[] }[] = [];
