...
// Request headers
export const X_MARKADO_SECRET_KEY = "x-markado-secret-key";
export const X_MARKADO_CLIENT_ID = 'x-markado-client-id';
...
export const VERSION_2025_06_17 = "2025-06-17";
...
export const MARKADO_API_VERSION_HEADER = "markado-api-version";
