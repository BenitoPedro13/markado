...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://markado.co";
...
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Markado.co, Inc.";
...
export const IS_MARKADO =
  ...
  new URL(WEBAPP_URL).hostname.endsWith("markado.qa") ||
  new URL(WEBAPP_URL).hostname.endsWith("markado-staging.com");
...
export const CONSOLE_URL =
  ...
  process.env.NODE_ENV !== "production"
    ? `https://console.markado.dev`
    : `https://console.markado.co`;
...
export const LOGO = "/markado-logo.svg";
export const LOGO_DARK = "/markado-logo.svg";
export const LOGO_ICON = "/markado-icon.svg";
...
export const ROADMAP = "https://markado.co/roadmap";
export const DESKTOP_APP_LINK = "https://markado.co/download";
export const JOIN_COMMUNITY = "https://github.com/markado/markado.co/discussions";
