import type { Payment, Webhook } from "~/prisma/app/generated/prisma/client";
import { createHmac } from "crypto";
import { compile } from "handlebars";

import type { TGetTranscriptAccessLink } from "@/packages/app-store/dailyvideo/zod";
...
const _sendPayload = async (
  ...
  const response = await fetch(subscriberUrl, {
    ...
    headers: {
      ...
      "X-Markado-Signature-256": createWebhookSignature({ secret: secretKey, body }),
    },
    redirect: "manual",
    body,
  });
