...
import { createInstantMeetingWithCalVideo } from "@/packages/core/videoClient";
import dayjs from "@/lib/dayjs";
import getBookingDataSchema from "@/packages/features/bookings/lib/getBookingDataSchema";
import { getBookingFieldsWithSystemFields } from "@/packages/features/bookings/lib/getBookingFields";
import { getBookingData } from "@/packages/features/bookings/lib/handleNewBooking/getBookingData";
import { getCustomInputsResponses } from "@/packages/features/bookings/lib/handleNewBooking/getCustomInputsResponses";
import { getEventTypesFromDB } from "@/packages/features/bookings/lib/handleNewBooking/getEventTypesFromDB";
import { getFullName } from "@/packages/features/form-builder/utils";
import { sendNotification } from "@/packages/features/notifications/sendNotification";
import { sendGenericWebhookPayload } from "@/packages/features/webhooks/lib/sendPayload";
import { isPrismaObjOrUndefined } from "@/packages/lib";
      ...
      actions: [
        {
          ...
          type: "button",
          image: "https://markado.co/api/logo?type=icon",
        },
      ],
    });
  });
