...
import type { BookerLayoutSettings, EventTypeMetaDataSchema } from "~/prisma/zod-utils";
...
import type { IntervalLimit, RecurringEvent } from "@/types/Calendar";
import { EventType } from "@/packages/event-types/getEventTypeBySlug";
import { ChildrenEventType } from "@/packages/types/App";
...
export type EventTypeAssignedUsers = EventType['eventType']['children'];
export type EventTypeHosts = EventType['eventType']['hosts'];
