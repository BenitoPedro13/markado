                  ...
                  onChange={(e: SingleValueLocationOption) => {
                    ...
                    if (e?.value) {
                      ...
                      if (canAddLocation) {
                        ...
                        notification({
                          title: t('location_already_exists'),
                          variant: 'stroke',
                          id: 'location_already_exists',
                          status: 'warning'
                        });
                      }
                    }
                  ...
                  <div className="w-full">
                    <div className="flex gap-2">
                      <div className="flex items-center justify-center">
                        <RiArrowRightDownLine name="corner-down-right" className="h-4 w-4" />
                      </div>
                      <LocationInput
          ...
          (location) =>
            ...
            <div className="text-default flex items-center text-sm">
              <div className="mr-1.5 h-3 w-3">
                <RiCheckLine name="check" className="h-3 w-3" />
              </div>
