...
export const getAllCredentials = async (
  user: { id: string; username: string | null; credentials: CredentialPayload[] },
  eventType: {
    userId?: string | null;
  ...
  for (const appKey in eventTypeAppMetadata) {
    ...
    if ("appCategories" in app! && app.appCategories && app.appCategories.some((category: string) => category === "crm")) {
