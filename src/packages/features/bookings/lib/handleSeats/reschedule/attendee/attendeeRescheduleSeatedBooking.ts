...
import type EventManager from "@/packages/core/EventManager";
// import { sendRescheduledSeatEmailAndSMS } from "@/emails";
import { getTranslation } from "@/packages/lib/server/i18n";
import {prisma} from "@/lib/prisma";
import type { Person, CalendarEvent } from "@/types/Calendar";
