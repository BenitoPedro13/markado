...
import { bookingResponsesDbSchema } from "@/packages/features/bookings/lib/getBookingResponsesSchema";
...
export const getBookingForReschedule = async (uid: string, userId?: string) => {
