import type { DestinationCalendar, BookingReference } from "~/prisma/app/generated/prisma/client";
...
import { createdEventSchema } from "~/prisma/zod-utils";
import type { EventTypeAppMetadataSchema } from "~/prisma/zod-utils";
import type { AdditionalInformation, CalendarEvent, NewCalendarEventType } from "@/types/Calendar";
