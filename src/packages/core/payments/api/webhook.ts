...
import stripe from "@/packages/app-store/stripepayment/lib/server";
import EventManager from "@/packages/core/EventManager";
import { sendAttendeeRequestEmailAndSMS, sendOrganizerRequestEmail } from "@/packages/emails";
import { doesBookingRequireConfirmation } from "@/packages/features/bookings/lib/doesBookingRequireConfirmation";
import { handleConfirmation } from "@/packages/features/bookings/lib/handleConfirmation";
...
import { getBooking } from "@/packages/lib/payment/getBooking";
import { handlePaymentSuccess } from "@/packages/lib/payment/handlePaymentSuccess";
...
/**
 * @deprecated
 * We need to create a PaymentManager in `@/packages/core`
