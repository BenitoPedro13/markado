...
export const OAuth2UniversalSchemaWithBackwardCompatibility = OAuth2UniversalSchema.extend({
  /**
...
export const OAuth2TokenResponseInDbWhenExistsSchema = OAuth2UniversalSchemaWithBackwardCompatibility;
export const OAuth2TokenResponseInDbSchema = OAuth2UniversalSchemaWithBackwardCompatibility.nullable();
