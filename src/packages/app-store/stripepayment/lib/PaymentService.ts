import type { Booking, Payment, PaymentOption, Prisma } from "~/prisma/app/generated/prisma/client";
...
import type { IAbstractPaymentService } from "@/packages/types/PaymentService";
    ...
    try {
      ...
      const params: Stripe.PaymentIntentCreateParams = {
        ...
        metadata: {
          ...
          bookingId,
          markadoAccountId: userId,
          markadoUsername: username,
          bookerName,
