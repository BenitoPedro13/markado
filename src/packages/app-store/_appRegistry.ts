import { appStoreMetadata } from "@/packages/app-store/appStoreMetaData";
...
import type { UserAdminTeams } from "@/repositories/user";
import {prisma} from "@/lib/prisma";
import { safeAppSelect, safeCredentialSelect } from '~/prisma/selects';
import { userMetadata } from "~/prisma/zod-utils";
import type { AppFrontendPayload as App } from "@/packages/types/App";
import type { CredentialFrontendPayload as Credential } from "@/packages/types/Credential";
...
export async function getAppRegistryWithCredentials(userId: string, userAdminTeams: UserAdminTeams = []) {
