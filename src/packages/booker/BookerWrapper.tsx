...
import type {BookerProps} from '@/packages/features/bookings/Booker';
import {Booker as BookerComponent} from '@/packages/features/bookings/Booker';
import {useBookerLayout} from '@/packages/features/bookings/Booker/components/hooks/useBookerLayout';
import {useBookingForm} from '@/packages/features/bookings/Booker/components/hooks/useBookingForm';
import {useBookings} from '@/packages/features/bookings/Booker/components/hooks/useBookings';
import {useCalendars} from '@/packages/features/bookings/Booker/components/hooks/useCalendars';
import {useSlots} from '@/packages/features/bookings/Booker/components/hooks/useSlots';
import {useVerifyCode} from '@/packages/features/bookings/Booker/components/hooks/useVerifyCode';
import {useVerifyEmail} from '@/packages/features/bookings/Booker/components/hooks/useVerifyEmail';
import {
  useBookerStore,
  useInitializeBookerStore
} from '@/packages/features/bookings/Booker/store';
import {
  useEvent,
  useScheduleForEvent
} from '@/packages/features/bookings/Booker/utils/event';
import {useBrandColors} from '@/packages/features/bookings/Booker/utils/use-brand-colors';
import {
