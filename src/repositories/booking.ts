...
export class BookingRepository {
  ...
  static async doesUserIdHaveAccessToBooking({
    userId,
    bookingId
  }: {
    userId: string;
  ...
  static async findFirstBookingByReschedule({
    originalBookingUid
  }: {
  ...
  static async findBookingForMeetingEndedPage({
    bookingUid
  }: {
    bookingUid: string;
  }) {
  ...
  static async findBookingByUidAndUserId({
    bookingUid,
    userId
  }: {
    bookingUid: string;
  ...
  static async getAllAcceptedTeamBookingsOfUser(
    params: TeamBookingsParamsWithCount
  ): Promise<number>;
  ...
  static async findOriginalRescheduledBooking(
    uid: string,
