...
export default function BookingSkeleton() {
  return (
    <div className="h-screen flex items-center justify-center bg-[url('/patterns/vertical_stripes.svg')] bg-no-repeat bg-[auto_500px] bg-bottom w-full" data-testid="success-page">
