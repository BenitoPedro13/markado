      ...
      >
        <rect
          ...
          className={cn(
            ...
            // focus
            'group-focus/checkbox:fill-primary-darker',
            // disabled
            ...
            // checked
            'group-data-[state=checked]/checkbox:fill-primary-darker',
            'group-data-[state=indeterminate]/checkbox:fill-primary-darker',
            // disabled checked
