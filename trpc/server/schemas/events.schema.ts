...
export const ZEventInputSchema = z.object({
  ...
  /**
   * Informs that the event request has been sent from a page that was reached by a redirect from non-org link(i.e. app.markado.co/username redirected to acme.markado.com/username)
